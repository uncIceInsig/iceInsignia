...
<button id="submitButton">Submit</button>
  <table class = Player1TeamList>
    <caption><?php echo $_SESSION['userName1'];?></caption>
    <tr>
      <th>Character</th>
      <th>Number</th>
    </tr>
  <form>
    <tr>
    <td><div class = char>
      <img src="Sprites\tank.gif" style="height: 100%; width: 100%" title="Warrior" alt='Fighter'>
    </div></td>
  ...
  <table class = Player2TeamList>
    <caption><?php echo $_SESSION['userName2']; ?></caption>
    <tr>
      <th>Number</th>
      <th>Character</th>
    </tr>
  <form>
    ...
    <td><div class = char><img src="Sprites\tank.gif" style="height: 100%; width: 100%" alt='Warrior' title="Fighter"></div></td></tr>
    ...
    <td><div class = char><img src="Sprites\mage.gif" style="height: 100%; width: 100%" alt="Mage" title="Mage"></div></td></tr>
  </form>
